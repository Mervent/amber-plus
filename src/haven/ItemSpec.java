...
public class ItemSpec implements GSprite.Owner, ItemInfo.SpriteOwner {
    ...
    public List<ItemInfo> info() {
        if (cinfo == null) {
            ...
            if (info == null) {
                /*
                 * XXX: This is quite dubious indeed, but it is currently necessary. Should
                 * DynName be lifted out of defn?
                 */
                info = new Object[] { new Object[] { res.res.get().pool.load("ui/tt/defn").get(), }, };
            }
