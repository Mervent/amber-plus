        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    /*
                     * The soft synthesizer appears to be throwing non-checked exceptions through
                     * from the sampled audio system. Ignore them and only them.
                     */
                ...
                try {
                    ...
                    try {
                        ...
                        if (e2 instanceof InterruptedException) {
                            /*
                             * XXX: There appears to be a bug in Sun's software MIDI implementation that
                             * throws back an unchecked InterruptedException here when two interrupts come
                             * close together (such as in the case when the current player is first stopped,
                             * and then another started immediately afterwards on a new song before the
                             * first one has had time to terminate entirely).
                             */
                        } else {
