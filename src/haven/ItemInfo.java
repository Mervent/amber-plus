...
public abstract class ItemInfo {
    ...
    public static class FactMaker implements Resource.PublishedCode.Instancer {
        public InfoFactory make(Class<?> cl) throws InstantiationException, IllegalAccessException {
            ...
            try {
                Function<Object[], ItemInfo> make = Utils.smthfun(cl, "mkinfo", ItemInfo.class, Owner.class,
                        Object[].class);
            ...
            try {
                Function<Object[], ItemInfo> make = Utils.smthfun(cl, "mkinfo", ItemInfo.class, Owner.class, Raw.class,
                        Object[].class);
                return (new InfoFactory() {
                    public ItemInfo build(Owner owner, Raw raw, Object... args) {
