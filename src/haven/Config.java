...
public class Config {
    ...
    public final static Set<String> locres = new HashSet<String>(Arrays.asList("gfx/terobjs/saltbasin",
            "gfx/terobjs/abyssalchasm", "gfx/terobjs/windthrow", "gfx/terobjs/icespire", "gfx/terobjs/woodheart",
            "gfx/terobjs/jotunmussel", "gfx/terobjs/guanopile", "gfx/terobjs/geyser", "gfx/terobjs/claypit",
            "gfx/terobjs/caveorgan", "gfx/terobjs/crystalpatch", "gfx/terobjs/fairystone", "gfx/terobjs/lilypadlotus"));

    public final static Set<String> mineablesStone = new HashSet<String>(Arrays.asList("gneiss", "basalt", "cinnabar",
            "dolomite", "feldspar", "flint", "granite", "hornblende", "limestone", "marble", "porphyry", "quartz",
            "sandstone", "schist", "blackcoal", "zincspar", "apatite", "fluorospar", "gabbro", "corund", "kyanite",
            "mica", "microlite", "orthoclase", "soapstone", "sodalite", "olivine", "alabaster", "breccia", "diabase",
            "arkose", "diorite", "kyanite", "slate"));
    ...
    public final static Set<String> mineablesCurios = new HashSet<String>(
            Arrays.asList("catgold", "petrifiedshell", "strangecrystal"));
    ...
    public final static HashMap<String, String[]> cures = new HashMap<String, String[]>(25) {
        {
            ...
            put("paginae/wound/deepcut", new String[] { "gfx/invobjs/gauze", "gfx/invobjs/stingingpoultice",
                    "gfx/invobjs/rootfill", "gfx/invobjs/herbs/waybroad", "gfx/invobjs/honeybroadaid" });
            put("paginae/wound/fellslash", new String[] { "gfx/invobjs/gauze" });
            put("paginae/wound/nicksnknacks", new String[] { "gfx/invobjs/herbs/yarrow", "gfx/invobjs/honeybroadaid" });
            ...
            put("paginae/wound/severemauling", new String[] { "gfx/invobjs/hartshornsalve", "gfx/invobjs/opium" });
            put("paginae/wound/swollenbump",
                    new String[] { "gfx/invobjs/coldcompress", "gfx/invobjs/leech", "gfx/invobjs/stingingpoultice" });
            put("paginae/wound/unfaced", new String[] { "gfx/invobjs/toadbutter", "gfx/invobjs/leech",
                    "gfx/invobjs/mudointment", "gfx/invobjs/kelpcream" });
            put("paginae/wound/wretchedgore", new String[] { "gfx/invobjs/stitchpatch" });
            put("paginae/wound/blackeye", new String[] { "gfx/invobjs/hartshornsalve", "gfx/invobjs/honeybroadaid",
            ...
            put("paginae/wound/infectedsore", new String[] { "gfx/invobjs/camomilecompress", "gfx/invobjs/soapbar",
                    "gfx/invobjs/opium", "gfx/invobjs/antpaste" });
            put("paginae/wound/nastylaceration", new String[] { "gfx/invobjs/stitchpatch", "gfx/invobjs/toadbutter" });
            put("paginae/wound/sealfinger",
                    new String[] { "gfx/invobjs/hartshornsalve", "gfx/invobjs/kelpcream", "gfx/invobjs/antpaste" });
            put("paginae/wound/coalcough", new String[] { "gfx/invobjs/opium" });
            put("paginae/wound/beesting", new String[] { "gfx/invobjs/kelpcream", "gfx/invobjs/antpaste" });
            put("paginae/wound/leechburns", new String[] { "gfx/invobjs/toadbutter" });
            put("paginae/wound/midgebite", new String[] { "gfx/invobjs/herbs/yarrow" });
            put("paginae/wound/sandfleabites", new String[] { "gfx/invobjs/herbs/yarrow" });
            put("paginae/wound/crabcaressed", new String[] { "gfx/invobjs/antpaste" });
        }
    };
