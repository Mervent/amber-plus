...
public class Skeleton {
    ...
    private static float[] vqrot(float[] d, float[] v, float[] q) {
        ...
        /*
         * I dearly wonder how the JIT's common-subexpression eliminator does on these.
         */
    ...
    private static float[] qqslerp(float[] d, float[] a, float[] b, float t) {
        ...
        if (cos > 0.9999f) {
            /*
             * Reasonable threshold? Is this function even critical for performance?
             */
            d0 = 1.0f - t;
            d1 = t;
        } else {
    ...
    public class Pose {
        ...
        public void boneoff(int bone, float[] offtrans) {
            ...
            offtrans[14] = xlate[2];
            /*
             * I must admit I don't /quite/ understand why the rotation needs to be
             * inverted...
             */
