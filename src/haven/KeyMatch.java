...
public class KeyMatch {
    ...
    public KeyMatch(char chr, boolean casematch, int code, boolean extmatch, String keyname, int modmask,
            int modmatch) {
    ...
    private boolean equals(KeyMatch that) {
        return ((this.chr == that.chr) && (this.casematch == that.casematch) && (this.code == that.code)
                && (this.extmatch == that.extmatch) && (this.modmask == that.modmask)
                && (this.modmatch == that.modmatch));
    }
