...
public class SslHelper {
    ...
    private synchronized SSLContext ctx() {
        if (ctx == null) {
            ...
            try {
                ...
                /*
                 * The key should be recoverable at this stage, since it was loaded
                 * successfully.
                 */
                throw (new RuntimeException(e));
    ...
    public synchronized void trust(Certificate cert) {
        ...
        try {
            ...
            /*
             * The keystore should have been initialized and should not have the generated
             * alias, so this should not happen.
             */
            throw (new RuntimeException(e));
        }
    }
