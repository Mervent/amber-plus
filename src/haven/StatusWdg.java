...
public class StatusWdg extends Widget {
    ...
    // GNU ping IPv4: 64 bytes from ansgar.seatribe.se (213.239.201.139): icmp_seq=1
    // ttl=50 time=72.5 ms
    // GNU ping IPv6: 64 bytes from ansgar.seatribe.se: icmp_seq=1 ttl=53 time=15.3
    // ms
    private final static Pattern pattern = Pattern
            .compile(Config.iswindows ? ".+?=(\\d+)[^ \\d\\s]" : ".+?time=(\\d+\\.?\\d*) ms");
            ...
            while (true) {
                ...
                try {
                    ...
                    while ((line = br.readLine()) != null) {
                        ...
                        // This of course might take more than 5 seconds in case there were no new
                        // logins/logouts
                    ...
                    // don't print socket exceptions when network is unreachable to prevent console
                    // spamming on bad connections
