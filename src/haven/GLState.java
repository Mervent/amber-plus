...
public abstract class GLState {
    ...
    public static class Applier {
        ...
        public void apply(GOut g) {
            ...
            /*
             * Note on invariants: States may exit non-locally from apply, applyto/applyfrom
             * or reapply (e.g. by throwing Loading exceptions) in a defined way provided
             * they do so before they have changed any GL state. If they exit non-locally
             * after GL state has been altered, future results are undefined.
             */
        ...
        public void clean() {
            ...
            if (now - lastclean > 60000) {
                ...
                /*
                 * XXX: Rehash into smaller table? It's probably not a problem, but it might be
                 * nice just for completeness.
                 */
                lastclean = now;
            }
        }
