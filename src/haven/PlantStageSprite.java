...
public class PlantStageSprite extends Sprite {
    ...
    private static final Tex stgmaxtex = Text
            .renderstroked("\u25CF", new Color(254, 100, 100), Color.BLACK, Text.num12boldFnd).tex();
    private static final Tex stghrvtex = Text
            .renderstroked("\u25CF", new Color(201, 180, 0), Color.BLACK, Text.num12boldFnd).tex();
    private static final Tex stgflwtex = Text
            .renderstroked("\u25CF", new Color(120, 120, 120), Color.BLACK, Text.num12boldFnd).tex();
