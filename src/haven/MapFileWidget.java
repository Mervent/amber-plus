...
public class MapFileWidget extends Widget {
    ...
    private static final double[] scaleFactors = new double[] { 1, 100 / 75.0, 100 / 50.0, 100 / 25.0, 100 / 15.0,
            100 / 8.0 };
                    ...
                    try {
                        ...
                        if (grid != null) {
                            ...
                            File tilefile = new File(
                                    String.format("map/%s/tile_%d_%d.png", session, disp.sc.x, disp.sc.y));
