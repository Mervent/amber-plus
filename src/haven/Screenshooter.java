...
public class Screenshooter extends Window {
    public static final ComponentColorModel outcm = new ComponentColorModel(ColorSpace.getInstance(ColorSpace.CS_sRGB),
    ...
    public static final ImageFormat jpeg = new ImageFormat() {
        ...
        public void write(OutputStream out, BufferedImage img, Shot info) throws IOException {
            ...
            Node mseq;
            for (mseq = root.getFirstChild(); (mseq != null)
                    && !mseq.getLocalName().equals("markerSequence"); mseq = mseq.getNextSibling())
                ;
            if (mseq == null) {
